...
| 06 | planned | Physics and collision foundation | Scene/package authored collision and basic queries/events work | Advanced plan suite committed, pushed, and reported on `sprint/alpha-06-physics-collision-foundation`. Dogfood collision migration should be scoped conservatively. |
