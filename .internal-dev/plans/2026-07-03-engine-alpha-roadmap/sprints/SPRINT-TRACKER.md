...
| 06 | executing | Physics and collision foundation | Scene/package authored collision and basic queries/events work | Phases 01-03 validated on `sprint/alpha-06-physics-collision-foundation`; dogfood migration deferred with debt artifact. Planning baseline was emailed. |
