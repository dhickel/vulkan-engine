...
| 06 | executing | Physics and collision foundation | Scene/package authored collision and basic queries/events work | Phases 01-02 validated on `sprint/alpha-06-physics-collision-foundation`; planning baseline was emailed. Dogfood collision migration should be scoped conservatively. |
