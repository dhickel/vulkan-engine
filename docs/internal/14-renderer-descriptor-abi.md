...
| 1 | `UBOParams` / `EnvironmentUBO` | 1920-byte UBO (CSM extended) | PBR/unlit fragment |
...
## `EnvironmentUBO` std140-compatible offsets (1920 B, CSM-extended)
...
| `cascade_count`, `_pad_cascade` | 120, 124 | 4 each |
