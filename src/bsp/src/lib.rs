...
pub use collision::{
    collect_clip_planes, convex_from_planes, CollisionRecipe, ConvexError, ConvexPiece,
};
...
pub use identity::{
    build_entity_identity, reconcile_identities, EntityFingerprint, EntityIdentity, IdentityEvent,
    IdentitySource,
};
pub use lightmaps::{
...
pub use package::{
    ...
    BspPackageManifest, BspPackageValidation, CompanionBinding, CompanionKind, CompileResult,
