...
pub use renderer::{
    ...
    FrameRenderOutcome, MaterialHandle, MeshHandle, ObjectLifecycleOutcome, ObjectMutationOutcome,
    ObjectSummary, PointLight, PointLightId, RenderHook, RenderHookContext, Renderer,
